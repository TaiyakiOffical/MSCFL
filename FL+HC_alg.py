    ...
    while current_round != 0:
        ...
        if cluster_switch:
            ...
            labels = AgglomerativeClustering(
                n_clusters=clusters_num, linkage="ward"
            ).fit_predict(para_lists)
...
def set_log(args):
    ...
    if args.partition == "quantity_based_LDS":
        log_file_path = os.path.join(args.logdir, f"FL+HC-label-{start_time}.log")
    else:
        log_file_path = os.path.join(args.logdir, f"FL+HC-feature-{start_time}.log")
